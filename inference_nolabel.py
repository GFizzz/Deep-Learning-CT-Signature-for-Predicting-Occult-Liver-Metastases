...
def main_test():
    ...
    phase1_dir = '/data/gzf/tumor_transfer/Dataset/nat/1max/output_boundingbox'
    phase2_dir = '/data/gzf/tumor_transfer/Dataset/nat/2max/output_boundingbox'
    phase3_dir = '/data/gzf/tumor_transfer/Dataset/nat/NC/output_boundingbox'
